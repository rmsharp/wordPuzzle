...
This is a hidden word puzzle maker. The user provides a text file with one or
...
the end of the word file. The configuration sextion begin on the line after a
...
filename <- "tests/books_of_bible.txt"
